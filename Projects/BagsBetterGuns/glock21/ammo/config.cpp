class CfgPatches
{
	class Ammo_Sample_338
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"DZ_Weapons_Ammunition"};
		magazines[] = {"Ammo_Sample_338"};
...
class cfgMagazines
{
	...
	class Ammo_Sample_338: Ammunition_Base
	{
		scope = 2;
...
{
	class Bullet_Base;
	class Bullet_Sample_338: Bullet_Base
	{
		scope = 2;
		cartridge = "FxCartridge_762";
		casing = "FxCartridge_762";
		round = "FxRound_308Win";
		spawnPileType = "Ammo_Sample_338";
		hit = 12;
		indirectHit = 0;
		indirectHitRange = 0;
		visibleFire = 22;
...
class cfgAmmoTypes
{
	class AType_Bullet_Sample_338
	{
		name = "Bullet_Sample_338";
	};
};
