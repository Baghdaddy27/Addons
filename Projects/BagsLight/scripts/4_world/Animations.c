...
// RIFLES
    override void RegisterFireArms( DayZPlayerType pType, DayzPlayerItemBehaviorCfg pBehavior )
    {
        ...
        pType.AddItemInHandsProfileIK("Bags_M14_Base", "DZ/anims/workspaces/player/player_main/weapons/player_main_m14.asi", pBehavior, "dz/anims/anm/player/ik/weapons/m14_ik.anm", "dz/anims/anm/player/reloads/m14/w_m14_states.anm");  

        pType.AddItemInHandsProfileIK("Bags_SV98_Base", "DZ/anims/workspaces/player/player_main/weapons/player_main_sv98.asi", pBehavior, "dz/anims/anm/player/ik/weapons/sv98.anm", "dz/anims/anm/player/reloads/sv98/w_sv98_states.anm");  
